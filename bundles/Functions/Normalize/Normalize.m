...
-(void)perform{
	...
	for(QuinceObject * quince in [mother valueForKey:@"subObjects"]){
		double vol = [[quince valueForKey:@"volume"]doubleValue] - max;
		[quince setValue: [NSNumber numberWithDouble:vol] forKey:@"volume"];
	}
