...
#import "RemoveGlissUp.h"

@implementation RemoveGlissUp
...
-(void)perform{
    ...
    for(QuinceObject * sub in [mother valueForKey:@"subObjects"]){
        if([[sub valueForKey:@"glissandoDirection"]intValue] == 0 || ![sub valueForKey:@"glissandoDirection"]){
	...
	[[result controller] setValue:[NSString stringWithFormat:@"%@_RmvGlssUp", [mother valueForKey:@"name"]] forKeyPath:@"selection.name"];  
