...
#import "VolumeStandardContainerTest.h"


@implementation VolumeStandardContainerTest

-(void)setUp{
	
	
	view = [[VolumeStandardContainer alloc]initWithFrame:NSMakeRect(0, 0, 100, 100)];	
